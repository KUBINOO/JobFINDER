...
const LOADING_MESSAGES = [
  ...
  "Filtruji zadané kraje a města v ČR...",
  "Scrapuji inzeráty z Jobs.cz a dalších zdrojů...",
  "Analyzuji a filtruji nalezené pozice podle lokality...",
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input 
              id="query-input"
              type="text"
              placeholder="např. React Developer, Projektový manažer, Finanční analytik..."
              value={query}
          ...
          <div className="space-y-2.5">
            <div className="flex items-center justify-between">
              <label className="text-sm font-semibold flex items-center gap-2">
                ...
                <span>Pracovní portály ({selectedSources.length}/{AVAILABLE_PORTALS.length})</span>
              </label>
